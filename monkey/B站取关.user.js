...
// @require      https://ghproxy.net/https://raw.githubusercontent.com/MonkSoul/Layx/master/layx.min.js
// @resource xcss https://ghproxy.net/https://raw.githubusercontent.com/MonkSoul/Layx/master/layx.min.css
// @require      https://ghproxy.net/https://raw.githubusercontent.com/mxk-zwh/jscdn/main/message.js
// @resource css https://ghproxy.net/https://raw.githubusercontent.com/mxk-zwh/jscdn/main/message.css
...
<div id="b-cancel-follow">
  <button class="b-btn cancel-hand">手动取关</button>
  <button class="b-btn clean_unuid">清理空号</button>
  <button class="b-btn next-page">下一页</button>
  <button class="b-btn cancel-auto">自动取关</button>
  <button class="b-btn auto-cancel">暂停取关</button>
</div>
`
