...
//         click("签到")
       ...
       //   var i=1;click('签到福利',i);
        ...
        var t = id("titleTextView").exists()
        if(t){
           sleep(10*1000)
           className("android.view.View").clickable(true).depth(12).textContains('天').find().click()&&console.log('签到')
        }else{
           back()
           sleep(2000)
           click('签到福利',0)
           sleep(4000)
           if(id("titleTextView").exists()){
              sleep(10*1000)
              className("android.view.View").clickable(true).depth(12).textContains('天').find().click()&&console.log('签到')
           }
        }
...
//         click("签到")
        ...
        sleep(20000)
        className("android.view.View").clickable(true).depth(13).textContains('天').find().click()&&console.log('点击')
        //绕过人机验证()
...
// function 八天签到() {
//     sleep(3000)
//     if (className("android.view.View").text("补签").exists()) {
